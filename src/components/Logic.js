export default function Logic (props) {
    ...
    if (index % 3 === 0 && board[index + 1] === board[index + 2] && board[index + 2] === curr)
      return GameWinner ("orizontal", index);

    if (index % 3 === 1 && board[index - 1] === board[index + 1] && board[index + 1] === curr)
      return GameWinner ("orizontal", index);

    if (index % 3 === 2 && board[index - 1] === board[index - 2] && board[index - 2] === curr)
      return GameWinner ("orizontal", index);

    if (index < 3 && board[index + 3] === board[index + 6] && board[index + 6] === curr)
      return GameWinner ("vertical", index);

    if (index < 6 && index > 2 && board[index - 3] === board[index + 3] && board[index + 3] === curr)
       return GameWinner ("vertical", index);

    if (index < 9 && index > 5 && board[index - 3] === board[index - 6] && board[index - 3] === curr) 
      return GameWinner ("vertical", index);
